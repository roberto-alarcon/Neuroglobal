...
* Description: Extend MotoPress Content Editor plugin with CherryFramework 4 shortcodes (old solution).
* Version: 1.0
* Author: MotoPress
...
class MPCE_Cherry4_Old {
    ...
    public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof MPCE_Cherry4_old ) ) {
			self::$instance = new MPCE_Cherry4_old;
		}
	...
	function __construct() {
        ...
        $is_mpc4_active = in_array(
            'motopress-cherryframework4/motopress-cherryframework4.php',
...
class MotoPress_Cherry4_Shortcode_Atts_Filter_Old {
...
function MPCECherry4_Old() {
	return MPCE_Cherry4_Old::instance();
}
MPCECherry4_Old();